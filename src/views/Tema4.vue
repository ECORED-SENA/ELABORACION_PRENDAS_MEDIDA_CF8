...
.curso-main-container.pb-3
  ...
  .container.tarjeta.tarjeta--blanca.p-4.p-md-5
    ...
    p.mb-4 Para el correcto manejo de residuos se hace indispensable saber la composición de esos textiles, esto por los siguientes factores:
      ...
      .col-10
        .row.borde-a.mb-4
          ...
          .col-9.d-flex.align-items-center
            p El poliéster es una base para construir textiles cuya composición no permite la transpiración fácilmente, dependiendo si es de chaquetas, polos o prendas más pesadas, también se encuentran ligeras que tienen efecto impermeable.
        ...
        .row.borde-a.mb-4
          ...
          .col-9.d-flex.align-items-center
            p El algodón, al ser una fibra natural, permite la transpiración, pero el ciclo de vida del producto es inferior al del poliéster u otra fibra sintética o artificial.
        ...
        .row.borde-a 
          ...
          .col-9.d-flex.align-items-center
            p No conocer la composición puede llegar a crear combinaciones inadecuadas para el bienestar de las personas y, al final, el producto no cumpliría su objetivo principal que es el de ser usado nuevamente
      .col-1
    ...
    .tabla-b.color-primario
      ...
      table        
        tr
          ...
          td 
            p.mb-0 Ovinos
            p.mb-0 Pelos finos (caprinos, camélidos, lepóridos)
            p.mb-0 Seda
          td 
            p.mb-0 Lana
            p.mb-0 Alpaca, Angora, Cachemira, Camello, Llama, Mohair, etc.
            p.mb-0 Bombix Mori. Tussah

        tr
          th Fibras Manufacturadas
          td 
            p.mb-0 Fruto
            p.mb-0 Tallo
            p.mb-0 Hoja
          td 
            p.mb-0 Algodón, Coco, Kapoc
            p.mb-0 Lino, Yute, Cáñamo, Ramio
            p.mb-0 Sisal, Formio, Abacá, Chaguar
    .tabla-b.color-primario.mb-4
      .tabla-b__header
        h2.mb-0 Fibras naturales
      table
        caption Tabla 1. Clasificación de las fibras textiles
        tr
          th Artificiales o Regeneradas
          td 
            p.mb-0 De celulosa
            p.mb-0 De celulosa regenerada
          td 
            p.mb-0 Rayón viscosa, Rayón modal, Rayón cuproamonio
            p.mb-0 Acetato de celulosa, triacetato de celulosa

        tr
          th Artificiales o Regeneradas
          td 
            p.mb-0 Monocomponentes
            p.mb-0 Biocomponentes
            p.mb-0 Microfibras
          td 
            p.mb-0 Poliamida, Poliéster, Acrílicas, 
            p.mb-0 Modacrílicas, Olefinicas, 
            p.mb-0 Elastometicas, Aramídicas
    ...
    .row.mb-4
      ...
      .col-8
        figure
          ...
          figcaption Figura 24. Manejo de residuos textiles.
      .col-2
